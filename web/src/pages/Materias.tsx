  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6 pb-20">
      ...
      <div className="flex justify-between items-center">
        ...
        <button
          onClick={() => { setMateriaEdicao(null); setModalMateriaOpen(true); }}
                ...
                >
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div className="hidden md:flex gap-1 mr-2" onClick={e => e.stopPropagation()}>
                      <button onClick={() => { setMateriaEdicao(materia); setModalMateriaOpen(true); }} className="p-2 text-gray-400 hover:text-blue-600 hover:bg-blue-50 rounded-lg" title="Editar Nome"><Pencil size={16} /></button>
                    ...
                    <div className="md:hidden" onClick={e => e.stopPropagation()}>
                      <MobileActionMenu
                        onEdit={() => { setMateriaEdicao(materia); setModalMateriaOpen(true); }}
      ...
      <Modal isOpen={modalMateriaOpen} onClose={() => setModalMateriaOpen(false)} title={materiaEdicao ? 'Editar Matéria' : 'Nova Matéria'}>
        <MateriaForm
          materiaEdicao={materiaEdicao}
          onSuccess={() => { setModalMateriaOpen(false); carregarMaterias(); }}
          onCancel={() => setModalMateriaOpen(false)}
        />
      </Modal>
